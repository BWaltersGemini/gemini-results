// src/pages/ParticipantPage.jsx (FINAL — New Palette + No Duplication + Crisp Card Preview)
...
export default function ParticipantPage() {
  ...
  // Direct link + QR code (using dark text for better contrast)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-light to-white pt-40 py-16">
      ...
      {/* Card Preview Modal — Crisp, Responsive, No Duplication */}
      {showCardPreview && (
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4 overflow-y-auto" onClick={() => setShowCardPreview(false)}>
          <div className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full mx-auto my-8 p-8 relative" onClick={e => e.stopPropagation()}>
            ...
            {/* Crisp Preview — Scales the actual hidden card */}
            <div className="flex justify-center mb-10">
              <div className="relative w-full max-w-lg aspect-square rounded-3xl overflow-hidden shadow-2xl border-8 border-gray-200">
