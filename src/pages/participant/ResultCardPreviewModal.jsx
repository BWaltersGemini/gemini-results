...
// FINAL FIXED — Beautiful Design Restored + No Cropping on Download
...
export default function ResultCardPreviewModal({
  ...
  const generateResultCard = async () => {
    ...
    try {
      const canvas = await html2canvas(cardRef.current, {
        scale: 3, // Higher scale for sharper image
        useCORS: true,
        allowTaint: true,
        ...
        width: 1080,
        height: 1080,
        // Critical: These prevent cropping
  ...
  return (
    <>
      {/* Hidden Full-Size Card — Original Beautiful Design (No Cropping Fix via html2canvas options) */}
      <div className="fixed -top-full left-0 opacity-0 pointer-events-none">
        ...
        >
          ...
          <p className="text-2xl text-gray-300 mb-10">{formatDate(selectedEvent.start_time)}</p>
      ...
      {/* Modal Preview — Same Beautiful Small Version */}
